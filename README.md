...
380K in size, and does all kinds of complicated joins and fancy TSQL manipulation.  See file [DacFxReverseEngineeingQuery2016.sql](ReverseEngineeringTableDump/DacFxReversEngineeingQuery2016.sql).
